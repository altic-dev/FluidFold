...
///   ~/Library/Logs/FluidFold/folds.log          one report block per fold, newest last
///   ~/Library/Logs/FluidFold/folds/fold-N.csv   one row per on-screen frame (last 30 folds kept)
///
