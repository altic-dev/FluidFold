#!/usr/bin/env python3
"""Summarize monotonic Duofy trace events. Ages are host pipeline timings, not optical lid latency."""
import argparse
import csv
import json
import statistics
...
if __name__ == "__main__":
    ...
    path = args.trace or max((Path.home() / "Library/Logs/DuofyTracking").glob("*.csv"), key=lambda p: p.stat().st_mtime)
